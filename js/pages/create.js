...
(function () {
  ...
  function renderDone() {
    ...
    <div class="create-done">
      ...
      <div class="create-done-support">
        <div class="create-done-support-inner">
          <div class="create-done-support-icon">✦</div>
          <div class="create-done-support-title">Підтримати розвиток проєкту</div>
          <div class="create-done-support-text">
          ...
          <a href="https://send.monobank.ua/jar/5se11GGQ5i" target="_blank" class="donation-btn">
            ${icon('heart', 16)} Задонатити через Monobank
          </a>
        </div>
      </div>
    </div>`;
