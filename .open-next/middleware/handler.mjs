...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let bs = { other: { l: "\u0406\u043D\u0448\u0435", e: "\u2728" }, birthday: { l: "\u0414\u0435\u043D\u044C \u043D\u0430\u0440\u043E\u0434\u0436\u0435\u043D\u043D\u044F", e: "\u{1F382}" }, wedding: { l: "\u0412\u0435\u0441\u0456\u043B\u043B\u044F", e: "\u{1F48D}" }, party: { l: "\u0421\u0432\u044F\u0442\u043E / \u0412\u0435\u0447\u0456\u0440\u043A\u0430", e: "\u{1F942}" }, meeting: { l: "\u0417\u0443\u0441\u0442\u0440\u0456\u0447", e: "\u{1F91D}" }, business: { l: "\u0420\u043E\u0431\u043E\u0447\u0430 \u0437\u0443\u0441\u0442\u0440\u0456\u0447", e: "\u{1F4BC}" }, date: { l: "\u041F\u043E\u0431\u0430\u0447\u0435\u043D\u043D\u044F", e: "\u{1F339}" }, cinema: { l: "\u041A\u0456\u043D\u043E", e: "\u{1F3AC}" }, coffee: { l: "\u041A\u0430\u0432\u0430", e: "\u2615" }, walk: { l: "\u041F\u0440\u043E\u0433\u0443\u043B\u044F\u043D\u043A\u0430", e: "\u{1F343}" }, travel: { l: "\u041F\u043E\u0434\u043E\u0440\u043E\u0436", e: "\u2708\uFE0F" }, trip: { l: "\u041F\u043E\u0434\u043E\u0440\u043E\u0436", e: "\u2708\uFE0F" }, sport: { l: "\u0421\u043F\u043E\u0440\u0442", e: "\u26BD" }, games: { l: "\u0406\u0433\u0440\u0438", e: "\u{1F3AE}" } };
      async function bt(a10) {
        let b2 = a10.nextUrl.pathname;
        if ((b2.startsWith("/i/") || b2.startsWith("/g/")) && !b2.includes("opengraph-image")) {
          if (a10.cookies.has("is_human") || a10.headers.has("rsc") || a10.headers.has("next-router-prefetch")) return S.next();
          let c2 = b2.startsWith("/g/"), d2 = b2.split("/")[2];
          if (!d2) return S.next();
          let e2 = null;
          try {
            let a11 = await fetch(`https://zaproshenya-82751-default-rtdb.europe-west1.firebasedatabase.app/${c2 ? "group-invites" : "invites"}/${d2}.json`, { next: { revalidate: 30 } });
            e2 = await a11.json();
          } catch (a11) {
            console.error("Middleware fetch error", a11);
          }
          let f2 = a10.headers.get("x-forwarded-host") || a10.headers.get("host") || "zaproshenya.site", g2 = f2.includes("localhost") ? "http" : "https", h2 = `${g2}://${f2}`, i2 = `${h2}/${c2 ? "g" : "i"}/${d2}/opengraph-image`, j2 = c2 ? "\u0413\u0440\u0443\u043F\u043E\u0432\u0435 \u0437\u0430\u043F\u0440\u043E\u0448\u0435\u043D\u043D\u044F" : "\u0417\u0430\u043F\u0440\u043E\u0448\u0435\u043D\u043D\u044F", k2 = c2 ? "\u0412\u0430\u043C \u043D\u0430\u0434\u0456\u0441\u043B\u0430\u043D\u043E \u0433\u0440\u0443\u043F\u043E\u0432\u0435 \u0437\u0430\u043F\u0440\u043E\u0448\u0435\u043D\u043D\u044F \u{1F31F}\n\n\u041D\u0430\u0442\u0438\u0441\u043D\u0456\u0442\u044C, \u0449\u043E\u0431 \u0432\u0456\u0434\u043A\u0440\u0438\u0442\u0438 \u0442\u0430 \u0434\u0456\u0437\u043D\u0430\u0442\u0438\u0441\u044F \u0434\u0435\u0442\u0430\u043B\u0456!" : "\u0412\u0430\u043C \u043D\u0430\u0434\u0456\u0441\u043B\u0430\u043D\u043E \u043F\u0440\u0438\u0432\u0430\u0442\u043D\u0435 \u0437\u0430\u043F\u0440\u043E\u0448\u0435\u043D\u043D\u044F \u{1F48C}\n\n\u041D\u0430\u0442\u0438\u0441\u043D\u0456\u0442\u044C, \u0449\u043E\u0431 \u0432\u0456\u0434\u043A\u0440\u0438\u0442\u0438 \u0442\u0430 \u0434\u0456\u0437\u043D\u0430\u0442\u0438\u0441\u044F \u0434\u0435\u0442\u0430\u043B\u0456!";
          if (e2) {
            let a11 = bs[e2.type] || bs.other;
            j2 = c2 ? `${a11.e} ${e2.title || "\u0413\u0440\u0443\u043F\u043E\u0432\u0435 \u0437\u0430\u043F\u0440\u043E\u0448\u0435\u043D\u043D\u044F"}` : `${a11.e} \u0417\u0430\u043F\u0440\u043E\u0448\u0435\u043D\u043D\u044F \u043D\u0430: ${a11.l}`;
          }
          return new S(`
<!DOCTYPE html>
<html lang="uk">
<head>
  ...
  <meta property="og:description" content="${k2}">
  <meta property="og:image" content="${i2}">
  ...
  <meta name="twitter:description" content="${k2}">
  <meta name="twitter:image" content="${i2}">
...
<body>
    ...
    `.trim(), { headers: { "Content-Type": "text/html; charset=utf-8", "Cache-Control": "no-store, max-age=0" } });
        }
        return S.next();
      }
      let bu = { matcher: ["/i/:id*", "/g/:id*"] };
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/i(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/g(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$"] }];
