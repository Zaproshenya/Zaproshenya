    ...
    <div style={{ maxWidth: '800px', margin: '40px auto 80px', padding: '0 20px', animation: 'fadeUp 0.6s var(--ease) both' }}>
      ...
      <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: '40px 32px', boxShadow: 'var(--shadow)' }}>
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: '24px', lineHeight: '1.7', color: 'var(--ink)', fontSize: '0.95rem' }}>
          ...
          <p>
            Сервіс «Запрошення» надає користувачам можливість створювати та надсилати картки-запрошення на зустрічі. Послуги надаються безкоштовно за принципом «як є» (as is). Ми не несемо відповідальності за будь-які технічні збої, втрату доступу чи невідповідність сервісу вашим очікуванням.
          </p>
          ...
          <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <li>Реєстрація з реальною електронною поштою дозволяє увімкнути двофакторну автентифікацію (2FA) для захисту акаунту та відновлювати пароль у разі його втрати.</li>
          ...
          <p>
            Адміністрація сайту залишає за собою право тимчасово обмежити доступ (бан) або повністю видалити акаунт користувача у разі порушення цих правил без попереднього попередження.
          </p>
