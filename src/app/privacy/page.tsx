    ...
    <div style={{ maxWidth: '800px', margin: '40px auto 80px', padding: '0 20px', animation: 'fadeUp 0.6s var(--ease) both' }}>
      ...
      <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 'var(--radius-card)', padding: '40px 32px', boxShadow: 'var(--shadow)' }}>
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: '24px', lineHeight: '1.7', color: 'var(--ink)', fontSize: '0.95rem' }}>
          <p>
            Ця Політика конфіденційності описує, як сервіс <strong>Запрошення</strong> (сайт <strong>zaproshenya.site</strong>) збирає, використовує та захищає вашу інформацію. Ми дуже серйозно ставимося до конфіденційності ваших особистих даних.
          </p>
          ...
          <ul style={{ paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <li><strong>Дані профілю:</strong> Ваше ім'я (яке ви вказали при реєстрації), унікальний логін та автоматично згенерований ZAP-ID.</li>
            <li><strong>Електронна пошта:</strong> Якщо ви реєструєтеся з реальною поштою або додаєте її для 2FA, ми зберігаємо її для відновлення пароля та надсилання одноразових кодів входу.</li>
            <li><strong>Аватарка:</strong> Фотографія вашого профілю (якщо ви вирішите завантажити її або увійти через Google).</li>
          ...
          <p>
            Уся інформація зберігається у безпечній хмарі бази даних Google Firebase Realtime Database. Ми використовуємо сучасні стандарти безпеки (шифрування передачі даних за протоколом SSL/TLS та правила доступу на рівні сервера) для запобігання несанкціонованому доступу.
          </p>
          <p>
            Ми **ніколи не продаємо**, не передаємо та не розкриваємо ваші дані стороннім компаніям, рекламодавцям чи іншим третім особам.
          </p>
          ...
          <p>
            Ми використовуємо технології локального збереження браузера (`sessionStorage` та `localStorage`) для того, щоб підтримувати вашу сесію активною (щоб не доводилося логінитися щоразу заново) та кешувати підтверджений статус 2FA протягом однієї сесії. Ми не використовуємо куки для відстеження ваших дій на інших сайтах чи реклами.
          </p>
